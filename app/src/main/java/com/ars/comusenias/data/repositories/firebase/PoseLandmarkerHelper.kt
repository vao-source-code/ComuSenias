...
import com.ars.comusenias.domain.models.mediapipe.DetectionPose
...
class PoseLandmarkerHelper(
    ...
    private var poseLandmarkerHelperListener: LandmarkerListener? = null
) {
    ...
    fun setupPoseLandmarker() {
       ...
       /* when (runningMode) {
        ...
        try {
            ...
            poseLandmarkerHelperListener?.onErrorPose(
    ...
    private fun returnLivestreamResult(
        ...
        poseLandmarkerHelperListener?.onResultsPose(
            DetectionPose(
                listOf(result),
                input.height,
                input.width
    ...
    interface LandmarkerListener {
        fun onErrorPose(error: String, errorCode: Int = OTHER_ERROR)
        fun onResultsPose(detectionPose: DetectionPose)
    }
